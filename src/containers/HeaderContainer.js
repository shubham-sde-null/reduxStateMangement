//we will copy everything what we did in Homecontainer just changing Home with Header in connect at bottom
import Header from "../components/Header";
import { connect } from "react-redux";
// here I do not want action
...
const mapDispatchToProps = (dispatch) => ({
    ...
    // Here I do not want any method to pass as props in Header I just want to use state
